...
$(document).ready(function() {   
    ...
    '.styleSwitcher #showHideSwitcher{outline:none; width:50px; height:50px; position:absolute; right:-50px; background:transparent; top:0; font-size:24px; text-align:center; line-height:50px; color:#555;}' +
    '</style>' +
